...
LOGIN = "test@friendwork.ru"
PASSWORD = "codder"
BASEURL = 'https://192.168.100.55:44306'
...
BASE_PAYLOAD_CANDIDATE = {
    ...
    "candidateId": None,
    "firstName": f"Тестовый {datetime.now().strftime('%m/%d')}",
    "middleName": f"Кандидат",
    "emails": [],
    "aboutMe": None,
    "position": None,
    "sex": 0,
...
BASE_PAYLOAD_VACANCY = {
    "accountId": 22014,
    "name": f"Тестовая Новая вакансия{datetime.now().strftime('%Y%m%d')}",
    "regionId": None,
    "suspensePeriods": [],
    "customerId": 0,
    "responsibleId": 22014,
